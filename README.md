...
- **Coverage ×3** — three independent passes ask *what exact assertion would reject a violation?* Candidates only, never a finding.
...
16 confirmed verifier bypasses across 5 DeepSWE tasks — see the **deep-swe-audits** repo for the full evidence bundles.
